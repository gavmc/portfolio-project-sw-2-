...
public class ANN1L extends ANNSecondary {
    ...
    /**
     * {@code float} representation of weight #1
     */
    private float w1;

    /**
     * {@code float} representation of weight #2
     */
    private float w2;

    /**
     * {@code float} representation of the learning rate
     */
    private float lr;
